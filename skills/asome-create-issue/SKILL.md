...
Use `references/issue-template.md`. Fill every section:

```markdown
<description of what this issue is about — 1-2 sentences>

**Requirements**             ← for Feature/Setup/Improvement
- requirement 1
- requirement 2

**Deliverables**             ← for Research/Docs
- [ ] deliverable 1
- [ ] deliverable 2

**Ref:** `reviste/api/src/<path>` ← when applicable (backend) or `reviste/web/src/<path>` (frontend)
